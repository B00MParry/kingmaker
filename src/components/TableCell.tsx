...
export const TableRowCell = ({ id, name, startDate, endDate, Budget, bgGray }: TableRowCellProps) => {
    ...
    return (
        <tr key={id} className={`${bgGray ? 'bg-gray-100' : 'bg-white'} border-b`}>
            ...
            <td className="flex items-center text-xs font-medium text-gray-900 px-6 py-4 uppercase tracking-wide">
                {active ?
                    <>
                        <svg
                            className="w-4 h-4 text-gray-400 inline mr-1 fill-green-600"
                            viewBox="0 0 24 24"
                        >
                    ...
                    : <>
                        <svg
                            className="w-4 h-4 text-gray-400 inline mr-1 fill-red-600"
                            viewBox="0 0 30 30"
                        >
