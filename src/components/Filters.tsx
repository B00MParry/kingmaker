...
export const Filters = () => {
    ...
    return (
        <>
            ...
            <input onChange={(e) => updateDates({ ...dates, startDate: e.currentTarget.value })} max={dates.endDate && dates.endDate} type="date" className="max-w-xs border text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block px-2 py-1" />
            <input onChange={(e) => updateDates({ ...dates, endDate: e.currentTarget.value })} min={dates.startDate && dates.startDate} type="date" className="max-w-xs border text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block px-2 py-1" />
        </>
    )
}